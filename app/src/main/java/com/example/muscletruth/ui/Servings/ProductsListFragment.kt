...
class ProductsListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        productsList = view.findViewById<RecyclerView>(R.id.fgt_products_list_products_rv)
        setupList()
        loadData()
        ...
        val addButton = view.findViewById<Button>(R.id.fgt_products_list_btn_add)
        addButton.setOnClickListener{
            val intent = Intent(requireContext(), AddProductActivity::class.java)
            addProductLauncher.launch(intent)
        }

        val backButton = view.findViewById<Button>(R.id.fgt_products_list_btn_back)
