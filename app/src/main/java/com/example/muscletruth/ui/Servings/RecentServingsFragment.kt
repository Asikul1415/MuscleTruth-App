...
//        }
    ...
    private fun loadData(){
        lifecycleScope.launch {
            try{
                servings = withContext(Dispatchers.IO){
                    ServingRepository.getRecentServings().map { it-> ServingRepository.getServing(it.servingServerID, it.servingLocalID)!!}.toMutableList()
                }
                Log.d("APP_DEBUG!", "RECENT $servings")
    ...
    private fun setupList() {
        ...
        adapter = ServingAdapter({serving ->
